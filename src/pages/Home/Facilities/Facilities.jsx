      ...
      <div className="grid md:grid-cols-3 items-center justify-items-center gap-x-16 gap-y-4">
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            <img
              ...
              alt="Card Image"
              className="w-full hover:scale-110 h-52 hover:transition-transform rounded-lg opacity-50"
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase   ">Football Field</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            ...
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase ">Training Gym</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            ...
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase   ">Locker Rooms</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            ...
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase   ">Cafeteria</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            ...
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase   ">Medical Room</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg w-96 ">
          <div className="relative">
            ...
            />
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <h3 className="text-5xl font-semibold text-[#173931] font-mono  uppercase   ">Swimming Pool</h3>
